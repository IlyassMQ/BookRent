...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="relative overflow-hidden bg-gradient-to-r from-amber-50 to-amber-100/30 rounded-2xl shadow-lg border border-amber-200 p-8 mb-8">
        ...
        {{-- Decorative book icon background --}}
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <p class="text-sm font-semibold text-amber-700 uppercase tracking-wider">Author Collection</p>
                    </div>
                    ...
                    <p class="text-stone-600">
                        <span class="inline-flex items-center gap-2">
                            ...
                            {{ $books->total() }} {{ Str::plural('book', $books->total()) }} in our collection
                        </span>
                    </p>
                </div>
                ...
                <div class="flex gap-3">
                    <div class="bg-white/80 backdrop-blur-sm rounded-xl px-4 py-2 border border-amber-200">
                        <p class="text-xs text-amber-700 font-semibold">Total Works</p>
            ...
            <div class="col-span-full">
                <div class="bg-white rounded-2xl shadow-xl border border-amber-100 p-12 text-center">
                    <div class="flex flex-col items-center gap-3">
                        ...
                        <p class="text-stone-400">We don't have any books by {{ $author }} in our collection yet.</p>
    ...
    @if($books->isNotEmpty())
        <div class="mt-12 bg-gradient-to-r from-amber-50 to-transparent rounded-xl p-5 border border-amber-100">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <p class="text-sm font-semibold text-[#2C1810]">About {{ $author }}</p>
                    <p class="text-sm text-stone-600 mt-1">
                        Explore the complete collection of books by {{ $author }}. 
                        From bestsellers to hidden gems, discover their literary works available for purchase or rental.
                    </p>
                </div>
            </div>
        </div>
