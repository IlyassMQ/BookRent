...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="relative overflow-hidden bg-gradient-to-r from-amber-50 via-amber-100/50 to-amber-50 rounded-2xl shadow-lg border border-amber-200 mb-10">
        ...
        {{-- Decorative location icon background --}}
        ...
        <div class="relative z-10 p-8 md:p-12 text-center">
            <div class="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 mb-4 shadow-sm">
                ...
                <span class="text-sm font-semibold text-amber-700">Local Discovery</span>
            </div>
            ...
            <p class="text-stone-600 text-lg max-w-2xl mx-auto">
                Discover books available in <span class="font-semibold text-amber-700">{{ auth()->user()->city ?? 'your city' }}</span>
            </p>
        </div>
    </div>
    ...
    @if($books->isEmpty())
        <div class="bg-white rounded-2xl shadow-xl border border-amber-100 p-16 text-center">
            <div class="flex flex-col items-center gap-4">
                ...
                <p class="text-stone-400 max-w-md">We couldn't find any books available in {{ auth()->user()->city ?? 'your city' }}. Try checking back later or browse books from other locations.</p>
