    ...
    @if($transactions->isNotEmpty())
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mb-8">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-transparent rounded-xl p-4 border border-blue-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs text-blue-700 font-semibold">Ready for Pickup</p>
            ...
            <div class="bg-gradient-to-r from-amber-50 to-transparent rounded-xl p-4 border border-amber-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs text-amber-700 font-semibold">Total Spent</p>
    ...
    @if($transactions->isEmpty())
        <div class="bg-white rounded-2xl shadow-xl border border-amber-100 p-16 text-center">
            <div class="flex flex-col items-center gap-4">
                ...
                <p class="text-stone-400 max-w-md">You haven't made any purchases or rentals yet. Start exploring our collection!</p>
                        ...
                        <div class="p-5">
                            ...
                            <div class="mb-3">
                                <a href="{{ route('books.show', $t->book->id) }}"
                                   class="text-base font-bold serif-font text-[#2C1810] hover:text-amber-700 transition line-clamp-1 block">
                                    {{ $t->book->title }}
                                </a>
                            ...
                            <div class="mt-auto pt-2 border-t border-amber-100">
                                @if($t->status === 'paid')
                                    <div class="mb-2 p-2 bg-stone-100 rounded-lg border border-stone-200">
                                        <div class="flex items-center justify-between">
                                            <span class="text-xs text-stone-500">Pickup Code:</span>
                                            <div class="font-mono font-bold text-amber-700 bg-white px-2 py-1 rounded border border-amber-200 text-sm">
                                                {{ $t->code_retrait }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-center gap-2 text-emerald-600 text-xs font-medium mb-2">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                                        </svg>
                                ...
                                @elseif($t->status === 'pending')
                                    <div class="flex items-center justify-center gap-2 text-yellow-600 text-xs font-medium mb-2">
                                        <svg class="w-3 h-3 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                ...
                                @else
                                    <div class="flex items-center justify-center gap-2 text-red-600 text-xs font-medium mb-2">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                        </svg>
                                ...
                                {{-- View Details Button --}}
                                <a href="{{ route('user.orders.show', $t) }}" 
                                   class="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm bg-stone-100 text-stone-700 rounded-lg hover:bg-stone-200 transition mt-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
